		...
		<div class="container">
			<div class = "row">
				<div style="width: 40%; margin: 25px auto;">
					...
					<form method="POST" action="doDangKy.jsp">
						...
						<div class="form-group">
							<button type="submit" class="btn btn-primary  btn-success btn-block">Đăng kí </button>
						</div>
					</form>
					<p>Bạn đã có tài khoản? <a href="GDDangNhap.jsp">Đăng nhập</a></p>
				</div>
			</div>
		</div>
